...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { color: @auto.color, description: @auto.description, madein: @auto.madein, name: @auto.name, type: @auto.type, went: @auto.went, year: @auto.year }
    end
  ...
  test "should update auto" do
    patch :update, id: @auto, auto: { color: @auto.color, description: @auto.description, madein: @auto.madein, name: @auto.name, type: @auto.type, went: @auto.went, year: @auto.year }
    assert_redirected_to auto_path(assigns(:auto))
  end
